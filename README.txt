...
Develop home automation and making it cheaper. Our technology is based on SmartBox (device)
which cointains a Raspberry PI3 & Arduino Uno and many sensors/actuators. SmartBox will run
python scripts.
